...
echo ==================== Grafana Built =======================
sudo git clone https://github.com/j13tw/School_Monitor_System.git /home/librenms/School_Monitor_System
sudo sed -i "3c command=python3 selfCheck.py $comm" /home/librenms/School_Monitor_System/Client/client.conf 
sudo python3 /home/librenms/School_Monitor_System/Client/enviroment.py
