...
sudo sed -i "3c command=python3 selfCheck.py $comm" /home/ubuntu/School_Monitor_System/Client/client.conf 
sudo python3 /home/ubuntu/School_Monitor_System/Client/enviroment.py
